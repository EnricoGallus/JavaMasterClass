...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Team<FootballPlayer>> teams = Arrays.asList(adelaideCrows, melbourne, fremantle, hawthorn);
        Collections.sort(teams);

        League<FootballPlayer> footballLeague = new League<>("Australia Football Premier");
